...
import {
  ...
  generateRiyadhWeatherData,
  generateRomeWeatherData,
  generateNewYorkWeatherData,
  generateLosAnglesWeatherData,
  generateMiamiWeatherData,
...
export const getWeatherData = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (city === "london") {
      ...
      console.log(generateRomeWeatherData());
      finalWeatherData = generateRomeWeatherData();
    } else if (city === "riyadh") {
      console.log(generateRiyadhWeatherData());
      finalWeatherData = generateRiyadhWeatherData();
    } else if (city === "newyork") {
      console.log(generateNewYorkWeatherData());
      finalWeatherData = generateNewYorkWeatherData();
    } else if (city === "losangels") {
      console.log(generateLosAnglesWeatherData());
      finalWeatherData = generateNewYorkWeatherData();
    } else if (city === "miami") {
      console.log(generateMiamiWeatherData());
      finalWeatherData = generateMiamiWeatherData();
    } else {
